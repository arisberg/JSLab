...
attendees = new Array ('Mia', 'Albert', 'Tony');
...
concatStrings("hello", " world");  // output is: hello world
...
repeatString(5, "hello");  // output is: hellohellohellohellohello
